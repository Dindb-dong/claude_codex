...
2. If scope is unclear, overlapping, risky, or blocked, write a ccx question and pause. Local question fallback counts as success.
...
7. Do not ask the user to approve ccx validation, question, barrier, or handoff commands.
8. On sandbox failure, report the exact failure to the conductor and stop, except for successful local question or handoff fallback.
